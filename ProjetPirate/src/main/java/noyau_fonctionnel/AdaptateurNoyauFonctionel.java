...
public class AdaptateurNoyauFonctionel implements IBoundary, INoyauFonctionnel {
    ...
    // Appelé par le Dialogue quand l'utilisateur clique sur le bouton "Jouer" après
    // avoir saisi les noms
    @Override
    public void soumettreNoms(String nomJ1, String nomJ2) {
        if (ctrlCommencer != null) {
            ctrlCommencer.initialiserJoueurs(nomJ1, nomJ2);
            String premier = ctrlCommencer.determinerJoueurQuiCommence();
    ...
    public void confirmationTourVu() {
        controlJeuPirate.lancerDesDuTour();
    }
    ...
    // Appelé by le Dialogue quand l'animation du pion (drag & drop) est terminée
    @Override
    public void confirmationDeplacement() {
        if (ctrlDeplacer != null) {
            IDeplacerPirate ctrl = ctrlDeplacer;
            ctrlDeplacer = null;
            ctrl.finDeplacerPirate();
        }
    }
    ...
    public void affichageResultatDe(int valeurDe1, int valeurDe2, ILancerDe ilancerDe) {
        ...
        // On attend confirmationDes() (fin animation)
    }
    ...
    public void deplacerPirates(String nomPirate, int ancienneCase, int nouvelleCase, IDeplacerPirate iDeplacerPirate) {
        ...
        // On attend confirmationDeplacement() (pion placé)
    }
    ...
    public void afficherEffetCase(String typeCase, String message, IActiverCase callback) {
        ...
        // On attend confirmationCaseSpeciale() (popup fermé)
    }
    ...
    public void afficherPointDeVie(String nomPirate, int pv, IPointsDeVie iPointDeVie) {
        ...
        // On attend confirmationPV() (affichage terminé)
    }
    ...
    public void afficherFinDePartie(String nomGagnant, IFinDePartie iFinDePartie) {
        ...
        // On attend confirmationFinPartie() (écran fermé)
    }

    @Override
    public void changerJoueurActif(String nomPirate, int position, int pv, ITourJoueur ctrl) {
        dialogue.afficherTourJoueur(nomPirate, position, pv);
        // On attend confirmationTourVu() (clic sur Lancer les dés)
    }
